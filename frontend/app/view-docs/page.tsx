                    ...
                    <div className="space-y-24">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="relative group">
                                ...
                                <img
                                    src={isDarkMode ? `${basepath}/ST1,2.png` : `${basepath}/ST1,2_w.png`}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                            ...
                            <div className="lg:order-1 lg:col-span-7 relative group">
                                ...
                                <div className="flex flex-col gap-6">
                                    <img
                                        src={isDarkMode ? `${basepath}/summary.png` : `${basepath}/summary_w.png`}
                                        alt="Analysis Summary UI"
                                        className="relative w-full h-auto rounded-2xl shadow-2xl border border-white/10"
                                    />
                                    <img
                                        src={isDarkMode ? `${basepath}/report.png` : `${basepath}/report_w.png`}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="relative group flex justify-center">
                                ...
                                <img
                                    src={isDarkMode ? `${basepath}/history.png` : `${basepath}/history_w.png`}
